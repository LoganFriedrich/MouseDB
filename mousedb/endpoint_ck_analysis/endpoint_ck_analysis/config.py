...
PACKAGE_DIR = Path(__file__).resolve().parent                  # endpoint_ck_analysis/endpoint_ck_analysis/
PROJECT_ROOT = PACKAGE_DIR.parent                              # endpoint_ck_analysis/ (outer tool folder)
