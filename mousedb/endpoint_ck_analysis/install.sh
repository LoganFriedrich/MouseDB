#!/usr/bin/env bash
# ============================================================================
#  Endpoint CK Analysis - macOS/Linux installer
#  ------------------------------------
#  Run from Terminal: cd to the endpoint_ck_analysis folder, then `./install.sh`
#
#  What this does:
...
#    4. Registers a Jupyter kernel called "Python (endpoint_ck_analysis)".
#
...
.venv/bin/python -m ipykernel install --user --name endpoint_ck_analysis --display-name "Python (endpoint_ck_analysis)"
