...
8. [`../endpoint_ck_analysis/config.py`](../endpoint_ck_analysis/config.py) -- every
   constant that governs the analysis lives here.
9. [`../endpoint_ck_analysis/data_loader.py`](../endpoint_ck_analysis/data_loader.py) --
   how the six base dataframes come out of the database.
10. [`../endpoint_ck_analysis/helpers/kinematics.py`](../endpoint_ck_analysis/helpers/kinematics.py)
    -- feature selection, aggregation, proportion computations.
11. [`../endpoint_ck_analysis/helpers/dimreduce.py`](../endpoint_ck_analysis/helpers/dimreduce.py)
    -- PCA per phase, PLS across blocks.
12. [`../endpoint_ck_analysis/helpers/models.py`](../endpoint_ck_analysis/helpers/models.py)
    -- LMM specification.
13. [`../endpoint_ck_analysis/helpers/clusters.py`](../endpoint_ck_analysis/helpers/clusters.py)
    -- clustering methods, cluster profiling / naming, permutation validity,
    alluvial record builder.
14. [`../endpoint_ck_analysis/helpers/synthetic.py`](../endpoint_ck_analysis/helpers/synthetic.py)
    -- generator for the cloned-and-perturbed synthetic cohort used to
    exercise the full pipeline at realistic N.
15. [`../endpoint_ck_analysis/helpers/hierarchical.py`](../endpoint_ck_analysis/helpers/hierarchical.py)
