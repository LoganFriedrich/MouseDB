@echo off
REM ============================================================================
REM  Endpoint CK Analysis - Windows installer
REM  ---------------------------------
REM  Double-click this file (or run it in a Command Prompt from the endpoint_ck_analysis/
...
REM    4. Registers a Jupyter kernel called "Python (endpoint_ck_analysis)" so the
...
echo.
echo === Endpoint CK Analysis installer ===
echo.
...
echo.
echo Registering Jupyter kernel "Python (endpoint_ck_analysis)" ...
".venv\Scripts\python.exe" -m ipykernel install --user --name endpoint_ck_analysis --display-name "Python (endpoint_ck_analysis)"
if errorlevel 1 (
