...
_pipeline_path = Path(os.environ.get(
    ...
    "Y:/LAB_ROOT/Behavior/MouseReach_Pipeline/Processing"
))
...
LDAP_SERVER = os.environ.get("MOUSEDB_LDAP_SERVER", "ldaps://INSTITUTION_NET.mu.edu:636")
LDAP_BASE_DN = os.environ.get("MOUSEDB_LDAP_BASE_DN", "DC=INSTITUTION_NET,DC=mu,DC=edu")
