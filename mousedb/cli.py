...
def cmd_dump(args):
    ...
    # Output directory
    output_dir = Path(args.output) if args.output else Path("Y:/LAB_ROOT/MouseDB/database_dump")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        prog='mousedb',
        description='MouseDB - Mouse Colony and Experiment Data Management'
    )
    ...
    dump_parser.add_argument('--output', '-o', help='Output directory (default: Y:/LAB_ROOT/MouseDB/database_dump)')
