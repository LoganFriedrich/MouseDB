...
def make_notebook(cells: list[tuple[str, str]]) -> dict:
    ...
    return {
        ...
        "metadata": {
            "kernelspec": {
                "display_name": "Python (cfs_analysis)",
                "language": "python",
                "name": "cfs_analysis",
            },
...
SETUP_NB = [
    ...
    ("md", """
        ...
        Runs ``cfs_analysis.doctor.doctor()`` which prints a table of required
...
CONNECTIVITY_PCA_NB = [
    ...
    ("code", """
        ...
        import cfs_analysis  # Soft-imports mousedb.region_priors with a frozen fallback
        from cfs_analysis import SKILLED_REACHING, ordered_hemisphere_columns
        from cfs_analysis.config import EXAMPLE_OUTPUT_DIR
        from cfs_analysis.data_loader import load_all
        from cfs_analysis.helpers.plotting import stamp_version
    ...
    """),
    ("code", """
        from cfs_analysis.config import CACHE_DIR
...
KINEMATIC_PCA_NB = [
    ...
    ("code", """
        ...
        from cfs_analysis.config import CACHE_DIR, EXAMPLE_OUTPUT_DIR
        from cfs_analysis.data_loader import load_all
        from cfs_analysis.helpers.dimreduce import run_pca_for_phase, align_signs_to_reference
        from cfs_analysis.helpers.plotting import plot_pca_for_phase, stamp_version
...
CLUSTERING_NB = [
    ...
    ("code", """
        ...
        from cfs_analysis.config import EXAMPLE_OUTPUT_DIR, METADATA_COLS
        from cfs_analysis.data_loader import load_all
        from cfs_analysis.helpers.plotting import stamp_version
...
PLS_VARIANTS_NB = [
    ...
    ("code", """
        ...
        from cfs_analysis.config import CACHE_DIR, EXAMPLE_OUTPUT_DIR
        from cfs_analysis.data_loader import load_all
        from cfs_analysis.helpers.dimreduce import build_y_phase, build_y_shift, run_pls
        from cfs_analysis.helpers.plotting import plot_pls, stamp_version
...
LMM_NB = [
    ...
    ("code", """
        ...
        from cfs_analysis.config import ANALYZABLE_PHASES, EXAMPLE_OUTPUT_DIR, CACHE_DIR, FDR_ALPHA
        from cfs_analysis.data_loader import load_all
        from cfs_analysis.helpers.kinematics import get_kinematic_cols
        from cfs_analysis.helpers.models import run_phase_lmm_for_features
        from cfs_analysis.helpers.plotting import stamp_version
...
TRAJECTORY_NB = [
    ...
    ("code", """
        ...
        from cfs_analysis import SKILLED_REACHING, ordered_hemisphere_columns
        from cfs_analysis.config import CACHE_DIR, EXAMPLE_OUTPUT_DIR, ANALYZABLE_PHASES
        from cfs_analysis.data_loader import load_all
        from cfs_analysis.helpers.clusters import (
...
HYPOTHESIS_NB = [
    ...
    ("code", """
        ...
        from cfs_analysis.config import CACHE_DIR, EXAMPLE_OUTPUT_DIR, ANALYZABLE_PHASES
        from cfs_analysis.data_loader import load_all
        from cfs_analysis.helpers.hierarchical import (
            build_group_region_map, drill_down_pca, grouped_vs_ungrouped_summary,
        )
        from cfs_analysis.helpers.dimreduce import (
            priority_weights_from_prior, apply_feature_weights,
        )
        from cfs_analysis.helpers.models import compare_nested_lmms
        from cfs_analysis.helpers.plotting import stamp_version
