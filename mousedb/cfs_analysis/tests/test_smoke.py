...
def test_package_imports():
    import cfs_analysis  # noqa: F401
    from cfs_analysis import SKILLED_REACHING, ordered_hemisphere_columns  # noqa: F401
    from cfs_analysis import region_prior_source
    assert region_prior_source() in {"mousedb", "fallback"}


def test_helpers_import():
    from cfs_analysis.helpers import (  # noqa: F401
        kinematics, connectivity, filters, dimreduce, models, plotting,
    )


def test_prefer_calibrated_units_drops_pixels_when_mm_exists():
    from cfs_analysis.helpers.kinematics import prefer_calibrated_units
...
def test_doctor_all_green():
    ...
    from cfs_analysis.doctor import run_checks
...
def test_synthetic_cohort_recovers_prototype_structure():
    ...
    """
    from cfs_analysis.data_loader import load_all
    from cfs_analysis.helpers.clusters import cluster_subjects
    from cfs_analysis.helpers.synthetic import prototype_map
