...
Usage:
    ...
    python -m mousedb.validate_data_locations --root Y:/LAB_ROOT
"""
...
def main(root: Optional[Path] = None) -> int:
    ...
    Args:
        root: Connectome root path. Defaults to Y:/LAB_ROOT.

    Returns:
        Exit code: 0 if all pass, 1 if any fail.
    """
    if root is None:
        root = Path("Y:/LAB_ROOT")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--root",
        default="Y:/LAB_ROOT",
        help="Connectome root directory (default: Y:/LAB_ROOT)",
    )
