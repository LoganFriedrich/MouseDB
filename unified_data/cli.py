...
def cmd_dump(args):
    ...
    # Output directory
    output_dir = Path(args.output) if args.output else Path("Y:/LAB_ROOT/Unified_Data/database_dump")
...
def main():
    ...
    dump_parser.add_argument('--output', '-o', help='Output directory (default: Y:/LAB_ROOT/Unified_Data/database_dump)')
